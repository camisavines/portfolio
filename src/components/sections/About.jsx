  ...
  const experience = [
    {
      ...
      highlights: ['Built scalable React applications', 'Improved performance by 40%', 'Led team of 4 developers']
    },
    {
      year: '2022 - 2024',
      role: 'Full Stack Developer',
      company: 'Digital Agency',
      description: 'Developed custom web solutions for clients, from concept to deployment.',
      highlights: ['Delivered 20+ client projects', 'Specialized in React & Node.js', 'Maintained 99.9% uptime']
    },
    {
      year: '2020 - 2022',
      ...
      highlights: ['Implemented responsive designs', 'Optimized load times', 'A/B tested features']
    }
  ];
            ...
            <motion.div variants={staggerItem} className="about__left">
              ...
              <div className="about__bio">
                <p className="body-base">
                  I believe the web should feel welcoming, not intimidating. Every project I take on
                  is an opportunity to create something that makes people feel confident and capable.
                </p>
                <p className="body-base">
                  With a background in full-stack development and a passion for user experience,
                  I bring both technical expertise and a human-centered approach to every build.
                ...
                <p className="body-base">
                  ...
                  design psychology, or contributing to open-source projects.
                </p>
              </div>
                  ...
                  {experience.map((job, index) => (
                    ...
                    >
                      ...
                      <div className="about__timeline-content">
                        ...
                        <p className="about__timeline-description">{job.description}</p>
